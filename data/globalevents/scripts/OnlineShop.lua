				...
				if(not item_doesnt_exist) then
					...
					if(full_weight <= free_cap) then
						...
						if(received_item == RETURNVALUE_NOERROR) then
							doPlayerSendTextMessage(cid, messageType, "You have received the item(s) '".. add_item_name .."' from the Zennia store. Thank you for your purchase.")
							...
							doPlayerSendTextMessage(cid, messageType, '>> '.. add_item_name ..' << from the Zennia store is waiting for you. Please make place for this item in your backpack/hands and wait about '.. interval ..' seconds to get it.')
						end
					else
						doPlayerSendTextMessage(cid, messageType, '>> '.. add_item_name ..' << from the Zennia store is waiting for you. It weight is '.. full_weight ..' oz., you have only '.. free_cap ..' oz. free capacity. Put some items in depot and wait about '.. interval ..' seconds to get it.')
					end
				end
