...
local voices = { {text = 'Don\'t forget to deposit your money here in the The Bank of Avalon before you head out for adventure.'} }
if VoiceModule then
...
npcHandler:setMessage(MESSAGE_GREET, "Yes? What may I do for you, |PLAYERNAME|? Do you need help with your {bank account}?")
