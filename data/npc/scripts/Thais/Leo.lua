...
talk = math.random(1,200)
	if talk == 1 then
		doCreatureSay(getNpcCid(), "Welcome to the post office!", TALKTYPE_SAY)
	elseif talk == 2 then
		doCreatureSay(getNpcCid(), "If you need help with letters or parcels, just ask me. I can explain everything.", TALKTYPE_SAY)
	elseif talk == 3 then
		doCreatureSay(getNpcCid(), "Hey, send a letter to your friend now and then. Keep in touch, you know.", TALKTYPE_SAY)
	end
return TRUE
end
